...
namespace WebApp.Controllers
{
    public class UsersInWorkoutController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NetUserId,WorkoutId,Id")] UsersInWorkout usersInWorkout)
        {
            ...
            ViewData["WorkoutId"] = new SelectList(_context.Workout, "Id", "Name", usersInWorkout.WorkoutId);
            return View(usersInWorkout);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("NetUserId,WorkoutId,Id")] UsersInWorkout usersInWorkout)
        {
